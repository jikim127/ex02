...
//	}
	...
	@PostMapping("remove")
	public String remove(@RequestParam("bno") Long bno, Criterial cri, RedirectAttributes rttr) {
		log.info("/remove : {}", bno);
	...
	@PostMapping("modify")
	public String modify(BoardVO vo, Criterial cri, RedirectAttributes rttr) {
		log.info("modify : {}" ,vo );
